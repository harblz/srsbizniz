...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_moment__ = __webpack_require__(55);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    postedOn: function postedOn(status) {
      return __WEBPACK_IMPORTED_MODULE_0_moment___default()(status.created_at).local().fromNow();
    }
  },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('article', {
      ...
      staticClass: "content"
    }, [_c('p', [_c('strong', [_vm._v(" " + _vm._s(status.user.name) + " ")]), _vm._v(" "), _c('small', [_vm._v(" " + _vm._s(status.user.email) + " ")]), _vm._v(" — "), _c('small', [_vm._v(" " + _vm._s(_vm._f("ago")(status.created_at)) + " ")]), _vm._v(" "), _c('br')]), _c('div', {
      domProps: {
        "textContent": _vm._s(status.body)
      }
    }), _vm._v(" "), _c('p')]), _vm._v(" "), _vm._m(1, true)])])
  }))])])])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('figure', {
